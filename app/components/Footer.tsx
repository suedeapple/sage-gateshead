    ...
    <footer className="footer">
      <div className="footer__content">
        <div className="footer__col">
          <a
            href="https://www.sagegateshead.com"
            target="_blank"
            rel="noopener"
          >
            <Image
      ...
      <div className="footer__credits">
        <p>
          Sage Gateshead is a registered charity, North Music Trust (Reg. Ch.
          No. 1087445).
        </p>
        <p>
          Sage Gateshead exists thanks to the support of public and private
          donations.
        </p>
        <p>© Copyright 2022</p>
      </div>
